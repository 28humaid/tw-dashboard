import { AttendanceCorrection, DepartmentAttendance, Device, HourlyShiftCoverage, LeaveInfo, StatCardProps } from "@/types/type";
...
export const dateWiseData = {
  ...
  "2026-03-16": {
    ...
    attendanceCards: [
      { title: "Total Requests", value: 42, color: "var(--color-active-members)" },
      { title: "Pending",        value: 14, percentage: 33, color: "var(--color-late)" },
      { title: "Approved",       value: 23, percentage: 55, color: "var(--color-present)" },
      { title: "Rejected",       value: 5,  percentage: 12, color: "var(--color-absent)" },
    ] as StatCardProps[],
    ...
    attendanceCorrections: [
      ...
      },
      {
        ...
        employeeId: "EMP-8912",
        attendanceDate: "2026-03-16",
        requestedPunchTime: "13:45",
        punchType: "IN",
        reason: "Forgot to punch in after lunch",
        appliedOn: "2026-03-17",
        status: "Rejected",
      },
      {
        ...
        requestedPunchTime: "09:00",
        punchType: "IN",
        reason: "Early arrival recorded wrong",
