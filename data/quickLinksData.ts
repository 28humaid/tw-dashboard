...
export const quickLinks: QuickLink[] = [
  { title: "quickLinks.reports.title", description: "quickLinks.reports.description", icon: BarChart2, route: "/home/employeeSelfService/attendance" },
  { title: "quickLinks.devices.title", description: "quickLinks.devices.description", icon: Monitor, route: "/home/masters/company" },
  { title: "quickLinks.alerts.title", description: "quickLinks.alerts.description", icon: Bell, route: "/home/masters/location" },
